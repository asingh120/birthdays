...
Program will display a list of names. When the user types a valid name
that persons birthday will display. If the user does not enter a valid
name, an error will be displayed and then can try again.
'''
